...
const progress = computed(
  () => ((currentIdx.value + 1) / questions.value.length) * 100
);
  ...
  <div class="test-container">
    ...
    <div v-if="step === 'setup'" class="setup-view">
      ...
      <div class="grid-box">
        ...
        <div class="card notebook" @click="startTest('notebook')">
          <div class="icon-box">
            <Star :size="40" color="#ecc94b" fill="#ecc94b" />
          </div>
          <h3>我的生词本</h3>
        </div>
        <!-- 词库入口 -->
    ...
    <div v-if="step === 'playing'" class="playing-view">
      ...
      <div class="question-card">
        ...
        <p class="q-phonetic" v-if="currentQ.phonetic">
          {{ currentQ.phonetic }}
        </p>
...
.result-item.wrong .r-word {
  color: #e53e3e;
  font-weight: bold;
}
.result-item.wrong .correct-ans {
  color: #38a169;
  font-size: 12px;
  margin-top: 2px;
}
